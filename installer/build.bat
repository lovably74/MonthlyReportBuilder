...
pyinstaller --noconfirm --onedir --name "cm-report-server" --add-data "alembic;alembic" --add-data "alembic.ini;." --hidden-import "aiosqlite" --hidden-import "sqlalchemy.dialects.sqlite" --hidden-import "uvicorn.logging" --hidden-import "uvicorn.loops.auto" --hidden-import "uvicorn.protocols.http.auto" --hidden-import "uvicorn.protocols.websockets.auto" --hidden-import "uvicorn.lifespan.on" --collect-all "zeroconf" --collect-all "uvicorn" --collect-all "fastapi" app\main.py
